    ...
    <section ref={sectionRef} className="relative z-20 w-full h-full flex items-center justify-center overflow-hidden text-white">
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <Button 
          ...
          size="lg" 
          variant="outline"
          className="group bg-transparent hover:bg-white hover:text-black border-2 border-white text-lg px-8 py-6 rounded-full transition-all duration-300 transform hover:scale-105 font-black animate-border-glow"
