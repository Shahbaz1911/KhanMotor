    ...
    <footer ref={footerRef} className="border-t border-white/10 bg-black text-gray-300">
      <div className="container mx-auto px-6 py-12">
        <div className="flex flex-col md:grid md:grid-cols-12 gap-y-10 md:gap-8">
          ...
          <div className="md:col-span-8 flex flex-col sm:flex-row md:flex-col lg:flex-row gap-y-10 md:gap-8 order-2 md:order-1 w-full text-center sm:text-left">
            {/* Contact Info */}
            <div className="w-full lg:w-1/2 flex flex-col items-center sm:items-start">
            ...
            {/* Social Media */}
            <div className="w-full lg:w-1/2 flex flex-col items-center sm:items-start mt-10 sm:mt-0 lg:mt-0 lg:pl-4">
