      ...
      {showHeader && (
        ...
        >
          ...
          <div className="flex items-center justify-end gap-[3px] sm:gap-[5px] min-w-[60px] sm:min-w-[70px]">
            <Signal
              className="text-black dark:text-white w-[11px] h-[11px] sm:w-[15px] sm:h-[15px]"
              strokeWidth={2.5}
            />
            <Wifi
              className="text-black dark:text-white w-[12px] h-[12px] sm:w-[16px] sm:h-[16px]"
              strokeWidth={2.5}
            />
            <Battery
              className="text-black fill-black dark:fill-white dark:text-white w-[18px] h-[18px] sm:w-[22px] sm:h-[22px]"
              strokeWidth={2.5}
            />
          </div>
        </div>
