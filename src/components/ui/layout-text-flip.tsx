...
export const LayoutTextFlip = ({
  ...
  return (
    <>
      ...
      <motion.span
        layout
        className="relative w-fit overflow-hidden rounded-md bg-transparent px-4 py-2 text-4xl font-black tracking-tight text-white drop-shadow-lg sm:text-6xl md:text-7xl"
      >
